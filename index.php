...
<body class="body-bg">
<!--? Preloader Start -->
<?php include "widgets/preloader_widget.php"; ?>

<header>
    <!-- Header Start -->

    <?php
        $headerData = getSectionData($pageSections, 'headerSection');
        $headerWidgets = $headerData->section_widget_list;
    ?>

    <div class="header-area">
        <div class="main-header">
            <div id="headerSectionWdg1">
                <?php                            
                    include "widgets/social_links_widget.php"; 
                ?>
            </div>
            <div id="headerSectionWdg2">
                <?php include "widgets/nav_bar_widget.php"; ?>
            </div>
        </div>
    </div>
    <!-- Header End -->
...
<main>
    ...
    <?php
        $mainData = getSectionData($pageSections, 'mainSection');
        $mainWidgets = $mainData->section_widget_list;
    ?>
...
<div id="back-top" >
    ...
    <script src="lib/section_manager.js"></script>
